...
(function() {
    ...
    vox.MeshBuilder = function(voxelData, param) {
        ...
        this.tesselation = param.tesselation === undefined ? vox.MeshBuilder.DEFAULT_PARAM.tesselation : param.tesselation;
    ...
    vox.MeshBuilder.prototype.build = function() {
        ...
        const tesselation = this.tesselation;

        this.voxelData.voxels.forEach(function(voxel) {
            var voxGeometry = this._createVoxGeometry(voxel);
            if (voxGeometry) {
                voxel.x += Math.random() * tesselation;
                voxel.y += Math.random() * tesselation;
                voxel.z += Math.random() * tesselation;
